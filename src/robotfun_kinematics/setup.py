...
setup(
    ...
    description="Cinemática directa/inversa (DH estándar, 4 GDL + gripper) "
                "del brazo RobotFun + secuenciador de pick & place.",
    license="MIT",
    ...
    entry_points={
        "console_scripts": [
            ...
            "pick_place_node = robotfun_kinematics.nodes.pick_place_node:main",
        ],
    },
)
